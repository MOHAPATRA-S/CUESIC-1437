...
const Header = (props) => {
    ...
    if (props.backOnly)
        ...
        <AppView style={[style.header, props.style]}>
            ...
            <AppView style={style.headerTitleContainer}>
                <AppText style={props.backcrossicon || props.Profileback ? style.headerTitleextra : style.headerTitle}>{props.title}</AppText>
            </AppView>
...
const Fixcomponent = (props) => {
    return (
        <AppView onPress={props.onPressfix} style={{
            position: "absolute" , alignItems: 'flex-end', width: width * 0.8, alignSelf: 'center',
        }}>
            <Touchable style={{
                width: 60, height: 70,
                zIndex: 2,
...
const StaticComponent = (props) => {
    return (
        <AppView
            style={{ alignItems: 'center', justifyContent: 'center', width: width * 0.87, alignSelf: 'center', }}>
            <AppView
                style={{
            ...
            <HTML html={props.staticcontent} style={[style.normalText, { fontSize: 17, fontWeight: "normal", width: width * 0.8 }]} imagesMaxWidth={width * 0.8} />
            {/* 
    ...
    <AppModal
        ...
        <AppView style={[style.mainContainer]} >
            <AppView style={[style.Modalcontainer,]}>
                <AppView style={{ flexDirection: 'row', justifyContent: 'flex-end', width: wp("80%"), alignItems: 'flex-end', }}>
                    {props.sessonManage ?
                        <Touchable onPress={props.onPressshare} >
                            <AppImage style={{ width: 18, height: 18, right: 10 }} source={props.share} />
                        </Touchable>
                    ...
                    <Touchable onPress={props.onPressClose} >
                    ...
                    renderItem={({ item, index }) =>
                        ...
                        >
                            <AppView style={{
                                ...
                                <AppImage style={{  height: 30, width: wp("20%") }} source={{ uri: item.image }} />
                                <AppText style={{
