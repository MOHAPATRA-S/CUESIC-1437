...
export default Cuemusic = (props) => {
    ...
    const Recently_played_list = ({ item, index }) => {
        ...
        return (
            <Touchable onPress={props.Page == undefined ? props.navigatefromsinglsong : () => songStoreinqueue({ "id": "hsfsdbvfhsbd" })
            }>
    ...
    const Myplaylist_list = ({ item, index }) => {
        ...
        return (
            <Touchable onPress={props.Page == undefined ? props.navigatlibrary :  () => Actions.Mylibrary({ "Page": "cuemusic" })}>
                <AppView style={style.unselectedLayout}>
                    <Image
                        style={{ marginHorizontal: 5, width: 120, height: 80, borderRadius: 10, }}
        ...
        return (
            <Touchable onPress={props.Page == undefined ? props.navigatlibrary :() => Actions.Mylibrary({ "Page": "cuemusic" })}>
                <AppView style={[style.unselectedLayout, {
                    ...
                    <Image
                        style={{ width: 180, height: props.Page == undefined ? 80 : 100, borderRadius: 10, }}
        ...
        {inbuiltstate.searchstatus?
           ...
           null
            ...
            <AppView style={{
                ...
                height: height <= 736 && props.Page == undefined ? 
                height * 0.41 : height > 736 && props.Page == undefined ? 
                height * 0.43:height==812&& props.Page == undefined ?height*3.4 : null,
                // height: height * 0.2,
                // marginBottom: 40,
                bottom: props.Page == undefined ? 0 : null,
                width,
                alignItems: 'center',
                alignSelf: 'center',
                justifyContent: 'center',
